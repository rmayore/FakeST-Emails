...
/**
 * Batch configuration for sending medium priority emails
 *
...
@Configuration
class MediumPriorityEmailJobConfiguration : DefaultBatchConfiguration() {

    companion object {
        const val STEP_NAME = "MEDIUM_SEND_EMAIL"
        const val JOB_NAME = "MEDIUM_PRIORITY_EMAIL_JOB"
    }
    ...
    fun reader() = IteratorItemReader(emailRepository.findByStatusAndPriority(Status.PENDING, Priority.MEDIUM))
}
